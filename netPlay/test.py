...
def getHistory(username, password):
    with Progress() as progress:
        task = progress.add_task("[cyan]Getting History...", total=1050)
    vedio_format_list = []
